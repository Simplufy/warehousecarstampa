...
const comparisons = {
  ...
  'toyota-camry-vs-honda-accord': {
    title: 'Toyota Camry vs Honda Accord | Midsize Sedan Battle | Warehouse Cars Tampa',
  ...
  'toyota-corolla-vs-hyundai-elantra': {
    title: 'Toyota Corolla vs Hyundai Elantra | Compact Sedan Value | Warehouse Cars Tampa',
  ...
  'honda-civic-vs-mazda3': {
    title: 'Honda Civic vs Mazda3 | Compact Sedan Fun | Warehouse Cars Tampa',
  ...
  'toyota-corolla-vs-honda-civic': {
    title: 'Toyota Corolla vs Honda Civic | Compact Reliability | Warehouse Cars Tampa',
  ...
  'honda-accord-vs-nissan-altima': {
    title: 'Honda Accord vs Nissan Altima | Midsize Sedan Value | Warehouse Cars Tampa',
  ...
  'hyundai-sonata-vs-toyota-camry': {
    title: 'Hyundai Sonata vs Toyota Camry | Midsize Sedan Features | Warehouse Cars Tampa',
  ...
  'kia-optima-vs-honda-accord': {
    title: 'Kia Optima vs Honda Accord | Midsize Sedan Comparison | Warehouse Cars Tampa',
  ...
  'honda-crv-vs-nissan-rogue': {
    title: 'Honda CR-V vs Nissan Rogue | Compact SUV Comfort | Warehouse Cars Tampa',
  ...
  'hyundai-tucson-vs-toyota-rav4': {
    title: 'Hyundai Tucson vs Toyota RAV4 | Compact SUV | Warehouse Cars Tampa',
  ...
  'kia-sportage-vs-hyundai-tucson': {
    title: 'Kia Sportage vs Hyundai Tucson | Korean SUV Showdown | Warehouse Cars Tampa',
  ...
  'mazda-cx5-vs-toyota-rav4': {
    title: 'Mazda CX-5 vs Toyota RAV4 | Compact SUV Driving | Warehouse Cars Tampa',
  ...
  'subaru-outback-vs-toyota-rav4': {
    title: 'Subaru Outback vs Toyota RAV4 | Adventure SUV | Warehouse Cars Tampa',
  ...
  'jeep-grand-cherokee-vs-ford-explorer': {
    title: 'Jeep Grand Cherokee vs Ford Explorer | Midsize SUV | Warehouse Cars Tampa',
  ...
  'toyota-highlander-vs-honda-pilot': {
    title: 'Toyota Highlander vs Honda Pilot | 3-Row SUV | Warehouse Cars Tampa',
  ...
  'chevrolet-traverse-vs-ford-explorer': {
    title: 'Chevy Traverse vs Ford Explorer | Large SUV | Warehouse Cars Tampa',
  ...
  'jeep-wrangler-vs-toyota-4runner': {
    title: 'Jeep Wrangler vs Toyota 4Runner | Off-Road SUV | Warehouse Cars Tampa',
  ...
  'toyota-tacoma-vs-ford-ranger': {
    title: 'Toyota Tacoma vs Ford Ranger | Midsize Truck | Warehouse Cars Tampa',
  ...
  'chevrolet-silverado-vs-ford-f150': {
    title: 'Chevy Silverado vs Ford F-150 | Full-Size Truck | Warehouse Cars Tampa',
  ...
  'honda-civic-vs-hyundai-kona': {
    title: 'Honda Civic vs Hyundai Kona | Sedan vs SUV | Warehouse Cars Tampa',
  ...
  'toyota-camry-vs-toyota-rav4': {
    title: 'Toyota Camry vs Toyota RAV4 | Sedan vs SUV | Warehouse Cars Tampa',
